...
namespace WareHouseSTARNET.ViewModels.MaterialViewModels
{
    public class MaterialCreateViewModel
    {
        ...
        [Required(ErrorMessage = "Krytické množství je povinné pole!")]
